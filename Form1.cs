...
namespace Bragin_Arcanoid
{
    public partial class Form1 : Form
    {
        ...
        Bitmap wall0, wall1Pur, wall2Pur, wall3Pur, wall4Pur, wall1Yel, wall2Yel,wall3Yel, wall1Green, wall2Green, wall1Gray;
        Player player;
        Wall wall;
        Ball ball;
        public int Nrnd = 0;
        ...
        private void Draw()
        {
            ...
            foreach (var wal in walls)
            {
                ...
                buffer.DrawString($"Очки: {scout.ToString()}", DefaultFont, new SolidBrush(Color.Orange), ClientRectangle.Width - 170, ClientRectangle.Height - 70);
